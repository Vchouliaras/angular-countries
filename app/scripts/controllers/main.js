...
angular.module('angularCountriesApp')
    ...
    $scope.selectedSearchInputTerm = function(value, rootScope = $rootScope) {
      var expression;
    ...
    $scope.selectedPopulationFilterChanged = function(value, rootScope = $rootScope) {
    ...
    $scope.selectedAreaFilterChanged = function(value, rootScope = $rootScope) {
    ...
    $scope.selectedCurrencyFilterChanged = function(value, rootScope = $rootScope) {
